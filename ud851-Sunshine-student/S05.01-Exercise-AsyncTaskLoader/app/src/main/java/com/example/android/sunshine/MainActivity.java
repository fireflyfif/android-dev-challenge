...
//
//        URL weatherLocationUrl = NetworkUtils.buildUrl(location);
//
//        Bundle weatherBundle = new Bundle();
//        weatherBundle.putString(weatherLocationUrl.toString());
//
//        LoaderManager loaderManager = getSupportLoaderManager();
//        Loader<String[]> weatherDataLoader = loaderManager.getLoader(WEATHER_LOADER);
...
//    }
    ...
    static class MyLoader extends AsyncTaskLoader<String[]> {
        ...
        protected void onStartLoading() {
            ...
            // If mWeatherData is not null, deliver the results. Otherwise, force a load
            if (mWeatherData != null) {
                deliverResult(mWeatherData);
            } else {
                // Show the loading indicator to the user when the loading in
         ...
         *
         * @return Weather dta from OpenWeatherMap as an Array of Strings
