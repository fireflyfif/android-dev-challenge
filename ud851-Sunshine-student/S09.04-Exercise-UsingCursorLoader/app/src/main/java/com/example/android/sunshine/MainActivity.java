...
//      COMPLETED (20) Implement LoaderCallbacks<Cursor> instead of String[]
    ...
    public String[] MAIN_FORECAST_PROJECTION = {
...
//      COMPLETED (25) Remove the deliverResult method declaration
        ...
        switch (id) {
            ...
            case ID_FORECAST_LOADER:
                ...
                /*
                A Selection in SQL declares which rows to return. In this case, all weather data
                from today onwards that is stored in the weather table
                */
