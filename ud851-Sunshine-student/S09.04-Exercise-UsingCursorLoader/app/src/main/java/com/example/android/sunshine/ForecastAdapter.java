...
//      COMPLETED (7) Generate a weather summary with the date, description, high and low
        ...
        long dateColumnIndex = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        // Get human readable string using utility method
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateColumnIndex, false);
        ...
        String highLowTemperature = SunshineWeatherUtils.formatHighLows(mContext, highInCelsius, lowInCelsius);

        String weatherSummary = dateString + " - " + description + highLowTemperature;
...
//  COMPLETED (11) Create a new method that allows you to swap Cursors.
     ...
     *
     * @param newCursor The new weather Cursor to be displayed.
     */
